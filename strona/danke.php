<?php
  ...
  if(!isset($_POST['submit'] ) ){
    header("Location: index.php?e=valid");
...
include('connect.php');	
      ...
      function validate($imie,$nazwisko,$email){
        ...
        if(!$imie || !$nazwisko || !$email){
          ...
          return true;
           ...
           if(!validate($imie,$nazwisko,$email)){
             
            header("Location: index.php?e=validate#zapisy");
             ...
             die();
                    ...
                    $result = $mysqli->query("SELECT * FROM zawodnicy ORDER BY id DESC LIMIT 1");                    
